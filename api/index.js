...
app.use("/images", express.static(path.join(__dirname, "/images"))); //making our images folder public
...
}).then(console.log("CONNECTED TO MONGODB")).catch((err)=>   //if connected it will show the message otherwise catch will give error
    console.log(err));
